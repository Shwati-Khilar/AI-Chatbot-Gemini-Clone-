...
//API Setup
const API_KEY = "AIzaSyBOm-umpryaXQ4Owkg_fkZRPIe_rzH6_x0";
...
//Similate typing effect for bot responses
...
//Making the API call and generating the bot's response
const generateResponse = async (botMsgDiv) => {
    ...
    try {
        ...
        //Process the response text and displaying with typing effect
...
//Handling file input change(file upload)
